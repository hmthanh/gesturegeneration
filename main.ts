...
dropzone.ondrop = function (evt: DragEvent) {
  ...
  const light1 = new THREE.DirectionalLight(new THREE.Color("#ffcccc"), 2);
  light1.position.set(-1, 1, 1);
  scene.add(light1);

  const light2 = new THREE.DirectionalLight(new THREE.Color("#ffcccc"), 2);
  light2.position.set(1, 1, 1);
  scene.add(light2);

  const light3 = new THREE.DirectionalLight(new THREE.Color("#ffcccc"), 2);
